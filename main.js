...
function gotResult(error, results) {
    ...
    document.getElementById('label').innerHTML = 'Tu dibujo: ' + drawn_sketch; document.getElementById('confidence').innerHTML = 'Confianza: ' + Math.round(results[0].confidence * 100) + '%';
}